                    ...
                    <tbody>
                      <tr>
                       ...
                       <img src="{{  ('/img/church/7.jpg') }}" alt="Hotel 2" height="50" width="70" class="img-fluid">
                        ...
                        <td class="fw-bold">
                            <audio src="avicii.mp3"
                                controls="true" autobuffer="true" class="btn btn-secondary btn-sm btn-outline-danger text-white fa fa-download mx-1">
                            </audio>
                    ...
                    <tbody>
                      <tr>
                       ...
                       <img src="{{  ('/img/church/7.jpg') }}" alt="Hotel 2" height="50" width="70" class="img-fluid">
                        ...
                        <video src="{{ asset('video/calvin.mp4') }}"
                            poster="../../images/calvin.jpg"
                            width="200" height="100"
                            preload="none" controls loop  class="btn btn-secondary btn-sm btn-outline-danger text-white fa fa-download mx-1">
