           ...
           <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="box box-primary"  >
                    <div class="box-header with-border">
                        ...
                        <div class="box box-info"></div>
                        <h5 style="text-align: center; font-size: 18; font-weight: 900;">Create New Post Category</h5>
                                        ...
                                        <div class="card-block">
                                            <div class="form-group has-primary row">
                                                    ...
                                                    <div class="col-sm-8 mr-5">
                                                        <textarea name="name" id="inputSuccess1" style="background-color: white;" class="form-control input-sm p-4 m-5 " rows="4" placeholder="write a category ..."></textarea>
                                                ...
                                                <div class=" mr-5" style="margin-inline-start: 79%">
                                                    <button type="submit" class=" b-b-primary btn-success btn-round btn btn-out btn-lg">Create</button>
                                                </div>
                                            </div>
                        </form>
