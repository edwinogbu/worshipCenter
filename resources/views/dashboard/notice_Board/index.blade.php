                ...
                <section class="content">
                        ...
                        {{-- notice_board_category_id,start_time,end_time,start_date,end_date,venue,banner,speaker, theme,topic, bible_text --}}
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <td>
                                                                        <span class="date">{{ Carbon\Carbon::parse($noticeBoard->created_at)->isoFormat('MMM Do YYYY') }}</span>
                                                                    ...
                                                                    <td class="text-right">
                                                                        ...
                                                                        <form style="display: inline" action="{{ route('user.noticeBoard.delete', $noticeBoard->id) }}" method="post">
                                                                            ...
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <a class="btn btn-primary btn-round btn-out btn-sm mr-3 " href="{{ route('user.noticeBoard.edit',$noticeBoardCategory->id) }}"><span class="glyphicon glyphicon-pencil btn-round btn-out"></span>Edit</a>
