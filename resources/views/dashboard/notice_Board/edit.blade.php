           ...
           <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="box box-danger"  >
                    ...
                    <div class="box-body box-profile box-body mx-4">
                        ...
                        <form action="{{ route('user.noticeBoardCategory.update', $noticeBoardCategory->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-header">
                                        ...
                                        <div class="card-block">
                                            <div class="form-group has-success row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input name="name" type="text" class="form-control form-control" id="inputSuccess1" value="{{ $category->name  }}">
                                                        @if ($errors->has('name'))
                                                ...
                                                <div class="text-right m-r-20">
                                                    <button type="submit" class=" b-b-primary btn-success btn-round btn btn-out">Update</button>
                                                </div>
                                            </div>
                        </form>
                            <div class="box box-danger"></div>
    ...
    <div class="row">
        <div class="col-xs-4">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">notice BoardCategory Modal </h3>
            </div>
            <div class="box-body">
