                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="table no-margin">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <td>
                                                                        <span class="date">{{ Carbon\Carbon::parse($noticeBoardCategory->created_at)->isoFormat('MMM Do YYYY') }}</span>
                                                                    ...
                                                                    <td class="text-right">
                                                                        ...
                                                                        <form style="display: inline" action="{{ route('user.noticeBoardCategory.delete', $noticeBoardCategory->id) }}" method="post">

                                                                            <div class="btn-group">

                                                                                <a class="btn btn-primary btn-round btn-out btn-sm mr-3 " href="{{ route('user.noticeBoardCategory.edit',$noticeBoardCategory->id) }}"><span class="glyphicon glyphicon-pencil btn-round btn-out"></span>Edit</a>
