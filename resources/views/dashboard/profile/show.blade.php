                ...
                <div class="box">
                    <!-- Profile Image -->
                        ...
                        @if ($profile->picture ==null)
                            ...
                            @else
                            {{-- <img src="{{ Storage::url($profile->picture) }}" alt="user image" class="img-radius img-40 align-top m-r-15"> --}}

                            <img class="profile-user-img img-responsive img-circle" src="{{ Storage::url($profile->picture) }}" alt="User profile picture" height="100" style="width: 150px; height: 150px; border: 1px solid #000000; border-radius:100px;">
                            @endif
                        <!-- Tithe Remark -->
