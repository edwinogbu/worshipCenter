                                    ...
                                    <div class="box box-danger"  >
                                        <div class="box-header with-border">
                                            <div class="user-block">
                                                    ...
                                                    <span class="username">
                                                        <a href="#">Income Category Lists: </a>
                                                    ...
                                                    <div class="text-right">
                                                        ...
                                                        {{-- <a class="btn btn-success btn-round btn-lg btn-out btn-md m-5 mb-4 ml-5 "  data-toggle="modal" data-target="#modal-income"><span class="glyphicon glyphicon-book btn-round btn-out"></span>Create Income</a> --}}
                                                                    ...
                                                                    <td class="text-right">
                                                                        ...
                                                                        <form style="display: inline" action="{{ route('user.incomeCategory.delete', $category->id) }}" method="post">
                                                                            ...
                                                                            <div class="btn-group">
                                                                                ...
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit" onclick="confirm('are you sure you want to delete? ')"  class=" btn btn-danger btn-round btn-out btn-sm mr-3 btn-danger btn-round btn-out"><span class="glyphicon glyphicon-trash btn-round btn-out"></span>Delete</button>
                                                                            </div>
